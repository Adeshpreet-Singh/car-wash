    ...
    <div>
          ...
          <div className="reveal" style={{ transitionDelay: '0.2s' }}>
            <div className="relative">
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl p-4 shadow-lg">
                <div className="text-2xl font-black" style={{ color: 'var(--accent)', fontFamily: "'Outfit', sans-serif" }}>45K+
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <details className="card" style={{ padding: '1.5rem' }}>
              ...
              <p style={{ marginTop: '1rem', color: 'var(--text-secondary)', lineHeight: '1.6' }}>Our pricing includes design, development, content integration, SEO optimization, and 30 days of post-launch support.</p>
                ...
                <div className="text-xs font-semibold" style={{ color: 'var(--body)' }}>Cars Detailed
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
          {stats.map((s, i) => (
            <div key={i} className="reveal">
              <div className="text-3xl md:text-4xl font-black" style={{ fontFamily: "'Outfit', sans-serif" }}>{s.number}
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            <details className="card" style={{ padding: '1.5rem' }}>
              ...
              <div className="text-xs font-semibold mt-1 opacity-80 uppercase tracking-wider">{s.label}
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <section id="services" className="py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-16 reveal">
            <div className="inline-block px-4 py-1 rounded-full text-xs font-bold mb-4" style={{ background: 'rgba(2,136,209,0.08)', color: 'var(--accent-dark)' }}>What We Do
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <section id="packages" className="py-20 md:py-28" style={{ background: 'var(--alt-bg)' }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 reveal">
            <div className="inline-block px-4 py-1 rounded-full text-xs font-bold mb-4" style={{ background: 'rgba(2,136,209,0.08)', color: 'var(--accent-dark)' }}>Pricing
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <section className="py-20 md:py-28">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12 reveal">
            <div className="inline-block px-4 py-1 rounded-full text-xs font-bold mb-4" style={{ background: 'rgba(2,136,209,0.08)', color: 'var(--accent-dark)' }}>Results
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <section id="gallery" className="py-20 md:py-28" style={{ background: 'var(--alt-bg)' }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 reveal">
            <div className="inline-block px-4 py-1 rounded-full text-xs font-bold mb-4" style={{ background: 'rgba(2,136,209,0.08)', color: 'var(--accent-dark)' }}>Gallery
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <div className="reveal" style={{ transitionDelay: '0.15s' }}>
            <div className="inline-block px-4 py-1 rounded-full text-xs font-bold mb-4" style={{ background: 'rgba(2,136,209,0.08)', color: 'var(--accent-dark)' }}>Why ShineOn
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <section id="reviews" className="py-20 md:py-28" style={{ background: 'var(--alt-bg)' }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16 reveal">
            <div className="inline-block px-4 py-1 rounded-full text-xs font-bold mb-4" style={{ background: 'rgba(2,136,209,0.08)', color: 'var(--accent-dark)' }}>Reviews
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            {testimonials.map((t, i) => (
              <div key={i} className="reveal rounded-2xl p-8 bg-white border transition-all hover:shadow-lg" style={{ borderColor: 'var(--border)', transitionDelay: `${i * 0.1}s` }}>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <div className="font-bold text-sm" style={{ color: 'var(--heading)', fontFamily: "'Outfit', sans-serif" }}>{t.name}
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <section id="contact" className="py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-16 items-start">
          <div className="reveal">
            <div className="inline-block px-4 py-1 rounded-full text-xs font-bold mb-4" style={{ background: 'rgba(2,136,209,0.08)', color: 'var(--accent-dark)' }}>Book Now
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
      ...
      <footer className="py-12" style={{ background: 'var(--heading)', color: '#a8b8cc' }}>
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-4"><span className="text-2xl">💧</span><span className="font-black text-white text-lg" style={{ fontFamily: "'Outfit', sans-serif" }}>ShineOn</span>
      <section className="section reveal">
        <div className="container" style={{ maxWidth: '800px' }}>
          <h2 className="text-center" style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '3rem' }}>Frequently Asked Questions</h2>
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
