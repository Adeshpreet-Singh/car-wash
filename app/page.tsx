...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#01579b] text-blue-50">
      {/* Skip link */}
      <a
        href="#main"
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-blue-500 text-black px-4 py-2 rounded z-[100] font-bold"
      >
        Skip to content
      </a>
      ...
      <nav
        ...
        className="fixed top-0 left-0 right-0 z-50 bg-[#01579b]/95 backdrop-blur-md border-b border-blue-900"
      >
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <div>
            <h1 className="text-xl font-bold water-shimmer">ShineZone</h1>
            <p className="text-base tracking-[0.2em] text-blue-600 uppercase">
              Car Wash — Phoenix
            </p>
          </div>
      ...
      <main id="main" role="main">
        ...
        <section className="hero pt-24">
          <div className="max-w-6xl mx-auto px-6 py-20 md:py-24 text-center">
            ...
            <p className="text-xl text-blue-300 max-w-xl mx-auto mb-10">
        ...
        {/* Stats bar */}
        <section className="reveal py-8 bg-blue-900/50">
          <div className="max-w-6xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div>
              <div className="text-3xl font-black text-blue-400">3 min</div>
            ...
            <div>
              ...
              <div className="text-xs text-blue-600 uppercase">Cars Washed</div>
            </div>
            <div>
              <div className="text-3xl font-black text-blue-400">80%</div>
              <div className="text-xs text-blue-600 uppercase">
                Water Reclaimed
              </div>
            </div>
        ...
        >
          <div className="max-w-5xl mx-auto px-6">
            <div className="text-center mb-16">
              <p className="badge text-blue-400 text-xs tracking-[0.3em] uppercase mb-2">
                Our Wash Menu
              </p>
              <h2
                id="packages-heading"
              ...
              <p className="text-blue-400 mt-3 max-w-lg mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {PACKAGES.map((pkg, i) => (
                <div
                  key={i}
                  className={`card wash-card p-8 rounded-2xl border border-blue-800 bg-blue-900/40 hover:border-blue-500/40 transition-colors ${pkg.featured ? 'featured ring-2 ring-blue-500' : ''}`}
                >
                  {pkg.featured && (
                    <div className="badge text-blue-400 text-xs font-bold uppercase tracking-wider mb-2">
                      Most Popular
                    </div>
                  )}
        ...
        <section
          id="addons"
          className="reveal py-24 section-alt bg-blue-900/30"
          ...
          <div className="max-w-4xl mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              {ADDONS.map((addon, i) => (
                <div
                  key={i}
                  className="card flex justify-between items-center border border-blue-800 rounded-xl px-6 py-4 bg-blue-900/40 hover:border-blue-500/30 transition-colors"
                >
                  <span className="text-blue-200">{addon.name}</span>
                  <span className="badge text-blue-400 font-bold">
                    {addon.price}
                  </span>
                </div>
              ))}
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {PLANS.map((p, i) => (
                <div
                  key={i}
                  className={`card wash-card p-8 text-center rounded-2xl border border-blue-800 bg-blue-900/40 hover:border-blue-500/40 transition-colors ${p.popular ? 'featured ring-2 ring-blue-500' : ''}`}
                >
                  {p.popular && (
                    <div className="badge text-blue-400 text-xs font-bold uppercase tracking-wider mb-2">
                      Best Value
                  ...
                  <p className="text-blue-300 text-sm mb-4">{p.washes}</p>
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {[
                ...
                <div key={i} className="text-center">
                  <div className="text-6xl font-black text-blue-800 mb-4">
                    {s.step}
                  </div>
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                <div
                  key={i}
                  className="card text-center p-8 rounded-2xl border border-blue-800 bg-blue-900/40 hover:border-blue-500/30 transition-colors"
                >
          ...
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {testimonials.map((t, i) => (
                <div
                  key={i}
                  className="card p-8 rounded-2xl border border-blue-800 bg-blue-900/40"
                >
                  ...
                  <div className="border-t border-blue-800 pt-3">
                    ...
                    <div className="text-blue-500 text-xs">{t.location}</div>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-4">
              {FAQS.map((faq, i) => (
                <details
                  key={i}
                  className="group border border-blue-800 rounded-xl p-6 cursor-pointer hover:border-blue-500/30 transition-colors"
                >
                  <summary className="font-bold flex justify-between items-center list-none">
                    {faq.q}
                    <span className="text-blue-400 text-2xl group-open:rotate-45 transition-transform">
                      +
                    </span>
                  </summary>
                  <p className="mt-4 text-blue-300 leading-relaxed">{faq.a}</p>
                </details>
              ))}
            </div>
          </div>
        ...
        >
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-12">
              <div className="card flex flex-col bg-blue-900/50 border border-blue-800 rounded-xl p-8 text-center">
              ...
              <div className="card bg-blue-900/50 border border-blue-800 rounded-xl p-8 text-center">
                <div className="text-3xl mb-3">📍</div>
            ...
            <div className="grid sm:grid-cols-3 gap-6 text-center mb-12">
              <div className="bg-blue-900/50 border border-blue-800 rounded-xl p-6">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="text-center mb-8">
                ...
                <p className="text-blue-400 text-sm">Have a question or special request? Fill out the form and we'll get back to you within 24 hours.</p>
              </div>
              {submitted ? (
                <div className="bg-blue-900/50 border border-blue-800 rounded-xl p-12 text-center">
                ...
                <form onSubmit={e => { e.preventDefault(); setSubmitted(true); }} className="bg-blue-900/50 border border-blue-800 rounded-xl p-8 space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm mb-2 text-blue-300">Name</label>
                      <input type="text" placeholder="Your name" required className="w-full bg-blue-950/50 border border-blue-800 rounded-lg px-4 py-3 text-blue-50 placeholder-blue-600 focus:border-blue-500 focus:outline-none transition-colors border border-gray-300  border-2 border-current/20" />
                    </div>
                    <div>
                      <label className="block text-sm mb-2 text-blue-300">Email</label>
                      <input type="email" placeholder="you@email.com" required className="w-full bg-blue-950/50 border border-blue-800 rounded-lg px-4 py-3 text-blue-50 placeholder-blue-600 focus:border-blue-500 focus:outline-none transition-colors border border-gray-300  border-2 border-current/20" />
                    </div>
                  </div>
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      <label className="block text-sm mb-2 text-blue-300">Phone</label>
                      <input type="tel" placeholder="(555) 123-4567" className="w-full bg-blue-950/50 border border-blue-800 rounded-lg px-4 py-3 text-blue-50 placeholder-blue-600 focus:border-blue-500 focus:outline-none transition-colors border border-gray-300  border-2 border-current/20" />
                    </div>
                    <div>
                      <label className="block text-sm mb-2 text-blue-300">Service Type</label>
                      <select className="w-full bg-blue-950/50 border border-blue-800 rounded-lg px-4 py-3 text-blue-50 focus:border-blue-500 focus:outline-none transition-colors border border-gray-300 ">
      ...
      <footer className="border-t border-blue-900 py-8">
        <div className="max-w-6xl mx-auto px-6 text-center text-blue-600 text-sm">
